...
<body>
    <div class="wrapper">
        ...
        <div class="text-container">
            ...
            <div class="text" id="scramble-text">Hacked by Siam</div>
        </div>

        <!-- Footer Section -->
        <div id="footer" class="animated bounceIn">
            <h1 id="greyshadow">This server have been hacked because you dont bring Paypal services in BD</h1>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const phrases = [
                'welcome',
                '<?php echo isset($pageTitle) ? $pageTitle : "to our website"; ?>'
            ];
